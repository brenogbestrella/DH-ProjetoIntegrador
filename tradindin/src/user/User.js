    ...
    <div className="User">
        ...
        <body>
            <div className="perfil">
                <h1>Editar Perfil</h1>
                <h2 className="user_h2">ID #784815</h2>
                <div className="perfil-nome">
                <h1>Nome</h1>
                <h2 className="user_h2">Ivens Junior</h2>
                ...
                <h1>E-mail</h1>
                <h2 className="user_h2">ivenjunior@gmail.com</h2>
                <button className="botao-editar" onclick="filterSelection('transhist1')">
                    EDITAR
                </button>
                </div>
                ...
                <h1>Documento</h1>
                <h2 className="user_h2">666.666.666-66</h2>
                <button className="botao-editar" onclick="filterSelection('transhist1')">
                    EDITAR
                </button>
                </div>
